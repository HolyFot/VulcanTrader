...
from VulcanTrader import __version__
from VulcanTrader.config.load_config import CONFIG_PARSE_MODE
...
class RemotePairList(IPairList):
    ...
    def fetch_pairlist(self) -> tuple[list[str], float]:
        headers = {"User-Agent": "VulcanTrader/" + __version__ + " Remotepairlist"}
