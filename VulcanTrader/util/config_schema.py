...
CONF_SCHEMA = {
    ...
    "properties": {
        ...
        "max_open_ratio": {
            "description": "Maximum ratio of wallet balance that can be deployed across all open trades at once.",
            "type": "number",
            "minimum": 0.0,
            "maximum": 1.0,
        },
        ...
        "telegram": {
            ...
            "properties": {
                ...
                "chat_id": {
                    "description": (
                        f"Telegram chat or group ID. {__VIA_ENV} VulcanTrader__TELEGRAM__CHAT_ID"
                    ),
                    "type": "string",
                },
                "topic_id": {
                    "description": (
                        ...
                        f"{__VIA_ENV} VulcanTrader__TELEGRAM__TOPIC_ID"
                    ),
                    "type": "string",
                },
                "authorized_users": {
        ...
        "webhook": {
            ...
            "properties": {
                ...
                "url": {
                    "description": f"Webhook URL. {__VIA_ENV} VulcanTrader__WEBHOOK__URL",
                    "type": "string",
                },
        ...
        "discord": {
            ...
            "properties": {
                ...
                "webhook_url": {
                    "description": (
                        f"Discord webhook URL. {__VIA_ENV} VulcanTrader__DISCORD__WEBHOOK_URL"
                    ),
                    "type": "string",
                },
                "bot_token": {
                    "description": (
                        f"Discord bot token for slash-command support. "
                        f"{__VIA_ENV} VulcanTrader__DISCORD__BOT_TOKEN"
                    ),
                    "type": "string",
                },
                "allowed_user_ids": {
                    "description": (
                        "Whitelist of Discord user IDs (integers) permitted to use bot commands. "
                        "If empty, all users can interact with the bot."
                    ),
                    "type": "array",
                    "items": {"type": "integer"},
                    "uniqueItems": True,
    ...
    "definitions": {
        "exchange": {
            ...
            "properties": {
                ...
                "key": {
                    "description": (
                        f"API key for the exchange. {__VIA_ENV} VulcanTrader__EXCHANGE__KEY"
                    ),
                    "type": "string",
                    "default": "",
                },
                "secret": {
                    "description": (
                        f"API secret for the exchange. {__VIA_ENV} VulcanTrader__EXCHANGE__SECRET"
                    ),
                    "type": "string",
                    "default": "",
                },
                "password": {
                    "description": (
                        ...
                        f"{__VIA_ENV} VulcanTrader__EXCHANGE__PASSWORD"
                    ),
                    "type": "string",
                    "default": "",
                },
                "uid": {
                    "description": (
                        ...
                        f"{__VIA_ENV} VulcanTrader__EXCHANGE__UID"
                    ),
                    "type": "string",
                },
                "account_id": {
                    "description": (
                        ...
                        f"{__VIA_ENV} VulcanTrader__EXCHANGE__ACCOUNT_ID"
                    ),
                    "type": "string",
                },
                "wallet_address": {
                    "description": (
                        ...
                        f"{__VIA_ENV} VulcanTrader__EXCHANGE__WALLET_ADDRESS"
                    ),
                    "type": "string",
                },
                "private_key": {
                    "description": (
                        ...
                        f"{__VIA_ENV} VulcanTrader__EXCHANGE__PRIVATE_KEY"
                    ),
                    "type": "string",
                },
                "pair_whitelist": {
