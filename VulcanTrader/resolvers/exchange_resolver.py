...
import VulcanTrader.exchange as exchanges
from VulcanTrader.constants import Config, ExchangeConfig
from VulcanTrader.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in VulcanTrader.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("VulcanTrader.", ""),
                    }
                )
        return result
