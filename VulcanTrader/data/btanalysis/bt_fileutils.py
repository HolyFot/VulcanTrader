...
from VulcanTrader.constants import LAST_BT_RESULT_FN
from VulcanTrader.util.exceptions import ConfigurationError, OperationalException
from VulcanTrader.util.backtest_result_type import BacktestHistoryEntryType, BacktestResultType
from VulcanTrader.util.misc import file_dump_json, json_load
from VulcanTrader.util.backtest_caching import get_backtest_metadata_filename
from VulcanTrader.persistence import LocalTrade, Trade, init_db
...
def load_trades_from_db(db_url: str, strategy: str | None = None) -> pd.DataFrame:
    ...
    filters: list = []
    if strategy:
        filters.append(lambda t: t.strategy == strategy)
