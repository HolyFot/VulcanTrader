...
from VulcanTrader.util import misc
from VulcanTrader.config.configuration import TimeRange
from VulcanTrader.constants import DEFAULT_TRADES_COLUMNS, ListPairsWithTimeframes
        ...
        if pairdf.empty:
            if warn_no_data:
                logger.warning(
                    ...
                    "Use `VulcanTrader download-data` to download the data"
                )
            return True
        elif warn_price:
            candle_price_gap = 0
