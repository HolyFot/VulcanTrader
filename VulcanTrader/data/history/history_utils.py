...
from VulcanTrader.exchange.exchange_utils import date_minus_candles
from VulcanTrader.pairlist.pairlist_helpers import dynamic_expand_pairlist
from VulcanTrader.util import dt_now, dt_ts, format_ms_time, format_ms_time_det
from VulcanTrader.util.migrations import migrate_data
from VulcanTrader.util.progress_tracker import CustomProgress, retrieve_progress_tracker
...
def refresh_backtest_ohlcv_data(
    ...
    *,
    ...
    Used by VulcanTrader download-data subcommand.
