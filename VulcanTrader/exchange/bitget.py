...
from VulcanTrader.enums import OPTIMIZE_MODES, CandleType, MarginMode, TradingMode
...
from VulcanTrader.exchange.common import API_RETRY_COUNT, retrier
from VulcanTrader.exchange.exchange_types import CcxtOrder, TraderHas
from VulcanTrader.util import dt_from_ts, dt_now, dt_ts
    ...
    def dry_run_liquidation_price(
        ...
        if self.trading_mode == TradingMode.FUTURES and self.margin_mode == MarginMode.ISOLATED:
            ...
            raise OperationalException(
                "VulcanTrader currently only supports isolated futures for bitget"
            )
