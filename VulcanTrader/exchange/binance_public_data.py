...
from VulcanTrader.constants import DEFAULT_TRADES_COLUMNS
from VulcanTrader.enums import CandleType
from VulcanTrader.util.misc import chunks
            ...
            for task in tasks:
                ...
                try:
                    ...
                    if stop_on_404:
                        ...
                        # https://github.com/VulcanTrader/VulcanTrader/blob/acc53065e5fa7ab5197073276306dc9dc3adbfa3/tests/exchange_online/test_binance_compare_ohlcv.py#L7
                        if current_day == 1:
                            logger.warning(
