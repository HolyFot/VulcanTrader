...
from VulcanTrader.exchange.exchange_types import CcxtBalances, TraderHas
...
class Kraken(Exchange):
    ...
    def calculate_funding_fees(
        ...
        """
        # ! This method will always error when run by VulcanTrader because time_in_ratio is never
