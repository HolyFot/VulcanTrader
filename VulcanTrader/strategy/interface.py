...
from VulcanTrader.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
from VulcanTrader.data.converter import populate_dataframe_with_trades
from VulcanTrader.data.converter.converter import reduce_dataframe_footprint
...
from VulcanTrader.util.exceptions import OperationalException, StrategyError
from VulcanTrader.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from VulcanTrader.trader_types import AnnotationType
from VulcanTrader.util.misc import remove_entry_exit_signals
from VulcanTrader.persistence import Order, PairLocks, Trade
from VulcanTrader.strategy.hyper import HyperStrategyMixin
from VulcanTrader.strategy.informative_decorator import (
    InformativeData,
    PopulateIndicators,
    _create_and_merge_informative_pair,
    _format_pair_name,
)
from VulcanTrader.strategy.strategy_validation import StrategyResultValidator
from VulcanTrader.strategy.strategy_wrapper import strategy_safe_wrapper
from VulcanTrader.util import dt_now, dt_ts
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for VulcanTrader strategies
    ...
    def __init__(self, config: Config) -> None:
        ...
        self.trader_informative: list[tuple[InformativeData, PopulateIndicators]] = []
        for attr_name in dir(self.__class__):
            cls_method = getattr(self.__class__, attr_name)
            if not callable(cls_method):
                continue
            informative_data_list = getattr(cls_method, "trader_informative", None)
            ...
            for informative_data in informative_data_list:
                ...
                self.trader_informative.append((informative_data, cls_method))

    def load_freqAI_model(self) -> None:
        if self.config.get("freqai", {}).get("enabled", False):
            # Import here to avoid importing this if freqAI is disabled
            from VulcanTrader.freqai.utils import download_all_data_for_training
            from VulcanTrader.resolvers.freqaimodel_resolver import FreqaiModelResolver
    ...
    def trader_bot_start(self, **kwargs) -> None:
        """
    ...
    def trader_bot_cleanup(self) -> None:
        """
    ...
    def confirm_trade_entry(
        ...
        **kwargs,
        ...
        For full documentation please go to https://www.VulcanTrader.io/en/latest/strategy-advanced/
    ...
    def adjust_entry_price(
        ...
        **kwargs,
        ...
        For full documentation please go to https://www.VulcanTrader.io/en/latest/strategy-callbacks/
    ...
    def feature_engineering_expand_all(
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://www.VulcanTrader.io/en/latest/freqai-parameter-table/#feature-parameters

        https://www.VulcanTrader.io/en/latest/freqai-feature-engineering/#defining-the-features
    ...
    def feature_engineering_standard(
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://www.VulcanTrader.io/en/latest/freqai-feature-engineering
    ...
    trader_stop_uses_after_fill = False
    ...
    def gather_informative_pairs(self) -> ListPairsWithTimeframes:
        ...
        for inf_data, _ in self.trader_informative:
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by VulcanTrader itself, but intended to be used if users lock pairs
    ...
    def should_exit(
        ...
        *,
        ...
        stoplossflag = self.trader_stoploss_reached(
            current_rate=current_rate,
            trade=trade,
            current_time=current_time,
            current_profit=current_profit,
    ...
    def trader_stoploss_adjust(
        ...
        :param bound_profit: profit at the candle bound, forwarded from should_exit
        """
        if after_fill and not self.trader_stop_uses_after_fill:
        ...
        if bound_profit is None:
            # should_exit forwards its precomputed value; after-fill paths recompute here.
    ...
    def trader_stoploss_reached(
        ...
        :param low: Low value of this candle, only set in backtesting
        :param high: High value of this candle, only set in backtesting
        :param bound_profit: profit at the candle bound, forwarded to trader_stoploss_adjust
        """
        self.trader_stoploss_adjust(
    ...
    def trader_check_timed_out(self, trade: Trade, order: Order, current_time: datetime) -> bool:
        """
        FT Internal method.
    ...
    def trader_advise_signals(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        """
    ...
    def advise_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for inf_data, populate_fn in self.trader_informative:
    ...
    def trader_plot_annotations(self, pair: str, dataframe: DataFrame) -> list[AnnotationType]:
        """
        ...
        if len(dataframe) > 0:
            ...
            from VulcanTrader.trader_types.plot_annotation_type import AnnotationTypeTA
